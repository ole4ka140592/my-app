...
//ASC Week 1 Challenge 4 (среда № 1) Напишите функцию, которая преобразует любое предложение в предложение V A P O R W A V E. предложение V A P O R W A V E преобразует все буквы в верхний регистр и добавляет 2 пробела между каждой буквой (или специальным символом), чтобы создать эффект V A P O R W A V E. Обратите внимание, что пробелы в этом случае следует игнорировать.
...
//Задача
// Даны делитель и граница. Найдите наибольшее целое число N, такое, что Условия :
// N делится на делитель N меньше или равно границе N больше 0. Заметки
// Параметры (делитель, граница), передаваемые в функцию, являются только положительными значениями. Гарантируется, что делитель найден. Ввод >> Примеры вывода
// maxMultiple (2,7) ==> возврат (6)
// Объяснение:
// (6) делится на (2) , (6) меньше или равно границе (7) , а (6) > 0 .
// maxMultiple (10,50) ==> возврат (50)
// Объяснение:
// (50) делится на (10) , (50) меньше или равно границе (50) , а (50) > 0 .* maxMultiple (37 200) ==> возврат (185)
// Объяснение:
// (185) делится на (37) , (185) меньше или равно границе (200) , а (185) > 0 . Игра с числами Игра со списками/массивами Bizarre Sorting-katas Для более приятных ката
// ВСЕ переводы приветствуются Наслаждайтесь обучением !! Зизу
